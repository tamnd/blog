...
- **[kernel-index](https://github.com/tamnd/kernel-index)**. Hand-curated index of every documentation page in the Linux kernel. 1,393 pages across 56 sections.
- **[cmu-database-group-videos-index](https://github.com/tamnd/cmu-database-group-videos-index)**. Every lecture and talk from the CMU Database Group YouTube channel. 585 videos, 35 playlists, 11 years of database systems education.
- **[dbdb-index](https://github.com/tamnd/dbdb-index)**. Every DBMS on dbdb.io, indexed. 1,071 systems with stats, charts, and full metadata.
...
- **[goipy](https://github.com/tamnd/goipy)**. Pure-Go CPython 3.14 bytecode interpreter. Runs `.pyc` files without cgo or an embedded CPython.
- **[gopygo](https://github.com/tamnd/gopygo)**. Transpiles CPython 3.14 `.pyc` files into standalone Go programs.

## Data & systems

- **[hn-fdw](https://github.com/tamnd/hn-fdw)**. Query the full Hacker News archive from Postgres via `duckdb_fdw`, with zero copies. Row groups stream straight from the Hugging Face Parquet dataset on demand.
...
- **[bgnet-vi](https://github.com/tamnd/bgnet-vi)**. Guide to Network Programming.
- **[bgc-vi](https://github.com/tamnd/bgc-vi)**. Guide to C.
- **[bgclr-vi](https://github.com/tamnd/bgclr-vi)**. Guide to the C Library Reference.
...
- **[kernel-worker](https://github.com/tamnd/kernel-worker)**. Cloudflare Worker serving the translated kernel docs at `kernel.go-mizu.dev`.
- **[ziglang-vi](https://github.com/tamnd/ziglang-vi)**. Vietnamese translation of `ziglang.org`.

**Python docs (PEP 545).**

- **[python-docs-vi](https://github.com/tamnd/python-docs-vi)**. Auto-synced from Transifex.
